...
import { ArticlePeek } from './article-peek/article-peek.js'
import { VideoPeek } from './video-peek/video-peek.js'
...
export default Vue.extend({
  ...
  data() {
    return {
      predictions: [] as ArticlePeek[],
      stocks: [] as ArticlePeek[],
      researches: [] as ArticlePeek[],
      investments: [] as ArticlePeek[],
      videos: [] as VideoPeek[],
    }
  },
  methods: {
